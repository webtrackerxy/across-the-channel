    ...
    out = {
        ...
        "conclusion": {
            ...
            "reasoning": [
                ...
                "Longer documented legs exist (straight-line: Yport -> Berck 116.5 km; Dieppe -> Stella-Plage 71.2 km; Utah Beach -> Eastney, Portsmouth, reported endpoints, 152.8 km, versus 35.4 km for Cap Blanc-Nez -> Dover), but they are isolated, selected cases; the coastal legs precede a pickup further north and are not longer loaded crossings.",
